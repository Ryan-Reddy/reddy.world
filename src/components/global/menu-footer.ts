  ...
  static get styles() {
    return [langCSS, css`
      ...
      nav ul li {
        ...
        margin: .5rem; // needed for the spacing on desktop of footer buttons
      }

      nav ul li a { // shape of the buttons in the footer
        color: var(--wit);
        border-radius: 8px;
      ...
      <nav>
        <div lang="en">
          <ul>
            ...
            <li><a class="nav-button" data-key="nav-btn-readme" href="readme" id="readme-button" aria-label="Readme">
              Readme</a>
            </li>
        ...
        <div lang="nl">
          <ul>
            ...
            <li><a class="nav-button" data-key="nav-btn-readme" href="/readme" id="readme-button" aria-label="Leesmij">
              Leesmij</a>
            </li>
            <li><a class="nav-button" data-key="nav-btn-friends" href="/support" id="support-button"
                   aria-label="Support">Support</a></li>
            <li><a class="nav-button" href="${this._contactClickedEnglish}" id="contact-button" aria-label="Contact">
              Contact</a>
            </li>
          </ul>
        </div>
