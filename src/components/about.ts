...
export class SupportElement extends LitElement {
  @property() _supportClicked = 'mailto:ryan@reddy.world?subject=Hello friend! I wish to speak to you!';
      ...
      <main>
        <div>
          ...
          <p>Take a look at my <a href="cv">CV</a> for more details about my professional accomplishments.
            <br>
          <a>You can email me at <a href="${this._supportClicked}">ryan@reddy.world</a>.
          </p>
        </div>
      </main>
      </body>
